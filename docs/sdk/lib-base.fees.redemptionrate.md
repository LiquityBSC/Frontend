...
|  --- | --- | --- |
|  redeemedFractionOfSupply | [Decimalish](./lib-base.decimalish.md) | The amount of FUSD being redeemed divided by the total supply. |
...
Unlike the borrowing rate, the redemption rate depends on the amount being redeemed. To be more precise, it depends on the fraction of the redeemed amount compared to the total FUSD supply, which must be passed as a parameter.

To calculate the redemption fee in FUSD, multiply the redeemed FUSD amount with the redemption rate.
