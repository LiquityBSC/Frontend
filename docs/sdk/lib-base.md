...
|  [LQTYStake](./lib-base.lqtystake.md) | Represents a user's LBSC stake and accrued gains. |
...
|  [LQTYStakeChange](./lib-base.lqtystakechange.md) | Represents the change between two states of an LBSC Stake. |
