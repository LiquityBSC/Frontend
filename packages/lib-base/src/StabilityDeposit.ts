...
export class StabilityDeposit {
  /** Amount of FUSD in the Stability Deposit at the time of the last direct modification. */
  readonly initialLUSD: Decimal;

  /** Amount of FUSD left in the Stability Deposit. */
  readonly currentLUSD: Decimal;

  /** Amount of native currency (e.g. Ether) received in exchange for the used-up FUSD. */
  readonly collateralGain: Decimal;

  /** Amount of LBSC rewarded since the last modification of the Stability Deposit. */
   ...
   *
   * @returns The new deposited FUSD amount.
   */
