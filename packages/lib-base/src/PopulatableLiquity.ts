 ...
 * some FUSD amounts are not possible to redeem exactly.
 *
...
export interface PopulatedRedemption<P = unknown, S = unknown, R = unknown>
  ...
  > {
  /** Amount of FUSD the redeemer is trying to redeem. */
  readonly attemptedLUSDAmount: Decimal;

  /** Maximum amount of FUSD that is currently redeemable from `attemptedLUSDAmount`. */
