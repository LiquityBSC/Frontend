...
export interface ReadableLiquity {
  ...
  /**
   * Get the remaining LBSC that will be collectively rewarded to stability depositors.
   */
  getRemainingStabilityPoolLQTYReward(): Promise<Decimal>;

  /**
   * Get the total amount of FUSD currently deposited in the Stability Pool.
   */
  getLUSDInStabilityPool(): Promise<Decimal>;

  /**
   * Get the amount of FUSD held by an address.
   *
  ...
  /**
   * Get the amount of LBSC held by an address.
   *
   * @param address - Address whose balance should be retrieved.
   */
  ...
  /**
   * Get the amount of Uniswap BNB/LUSD LP tokens held by an address.
   *
   * @param address - Address whose balance should be retrieved.
   */
  ...
  /**
   * Get the liquidity mining contract's allowance of a holder's Uniswap BNB/LUSD LP tokens.
   *
   * @param address - Address holding the Uniswap BNB/LUSD LP tokens.
   */
  getUniTokenAllowance(address?: string): Promise<Decimal>;

  /**
   * Get the remaining LBSC that will be collectively rewarded to liquidity miners.
   */
  getRemainingLiquidityMiningLQTYReward(): Promise<Decimal>;

  /**
   * Get the amount of Uniswap BNB/LUSD LP tokens currently staked by an address in liquidity mining.
   *
  ...
  /**
   * Get the total amount of Uniswap BNB/LUSD LP tokens currently staked in liquidity mining.
   */
  getTotalStakedUniTokens(): Promise<Decimal>;

  /**
   * Get the amount of LBSC earned by an address through mining liquidity.
   *
   * @param address - Address whose LBSC reward should be retrieved.
   */
   ...
   *
   * @param address - Address that owns the LBSC Stake.
   */
  getLQTYStake(address?: string): Promise<LQTYStake>;

  /**
   * Get the total amount of LBSC currently staked.
   */
