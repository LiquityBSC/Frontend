...
export interface TroveCreationDetails {
  ...
  /** Amount of FUSD added to the Trove's debt as borrowing fee. */
  fee: Decimal;
}
...
export interface LiquidationDetails {
  ...
  /** Amount of FUSD paid to the liquidator as gas compensation. */
...
export interface RedemptionDetails {
  /** Amount of FUSD the redeemer tried to redeem. */
  attemptedLUSDAmount: Decimal;

  /**
   * Amount of FUSD that was actually redeemed by the transaction.
   *
   * @remarks
...
export interface StabilityPoolGainsWithdrawalDetails {
  /** Amount of FUSD burned from the deposit by liquidations since the last modification. */
  lusdLoss: Decimal;

  /** Amount of FUSD in the deposit directly after this transaction. */
  newLUSDDeposit: Decimal;

  /** Amount of native currency (e.g. Ether) paid out to the depositor in this transaction. */
  collateralGain: Decimal;

  /** Amount of LBSC rewarded to the depositor in this transaction. */
  lqtyReward: Decimal;
}
...
export interface TransactableLiquity {
  /**
   * Open a new Trove by depositing collateral and borrowing FUSD.
   *
  ...
  /**
   * Adjust existing Trove by borrowing more FUSD.
   *
   * @param amount - The amount of FUSD to borrow.
   * @param maxBorrowingRate - Maximum acceptable
   *                           {@link @liquity/lib-base#Fees.borrowingRate | borrowing rate}.
   *
   * @throws
   ...
   *
   * @param amount - The amount of FUSD to repay.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   *
   ...
   *
   * @param amount - Amount of FUSD to add to new or existing deposit.
  ...
  /**
   * Withdraw FUSD from Stability Deposit.
   *
  ...
  /**
   * Send FUSD tokens to an address.
   *
   * @param toAddress - Address of receipient.
   * @param amount - Amount of FUSD to send.
   *
   * @throws
   * Throws {@link TransactionFailedError} in case of transaction failure.
   */
  ...
  /**
   * Redeem FUSD to native currency (e.g. Ether) at face value.
   *
   * @param amount - Amount of FUSD to be redeemed.
  ...
  /**
   * Allow the liquidity mining contract to use Uniswap BNB/FUSD LP tokens for
  ...
  /**
   * Stake Uniswap BNB/FUSD LP tokens to participate in liquidity mining and earn LQTY.
   *
  ...
  /**
   * Withdraw Uniswap BNB/FUSD LP tokens from liquidity mining.
   *
