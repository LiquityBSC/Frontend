...
export class Fees {
   ...
   * the `when` parameter.
   *
   * To calculate the borrowing fee in FUSD, multiply the borrowed FUSD amount by the borrowing rate.
   *
   * @example
   * ```typescript
   ...
   *
   * @param redeemedFractionOfSupply - The amount of FUSD being redeemed divided by the total supply.
   ...
   * precise, it depends on the fraction of the redeemed amount compared to the total FUSD supply,
   * which must be passed as a parameter.
   *
   * To calculate the redemption fee in FUSD, multiply the redeemed FUSD amount with the redemption
   * rate.
   *
   * @example
   * ```typescript
