...
export interface LiquityStoreBaseState {
  ...
  /** User's FUSD token balance. */
  lusdBalance: Decimal;

  /** User's LBSC token balance. */
  lqtyBalance: Decimal;

  /** User's Uniswap BNB/FUSD LP token balance. */
  uniTokenBalance: Decimal;

  /** The liquidity mining contract's allowance of user's Uniswap BNB/FUSD LP tokens. */
  uniTokenAllowance: Decimal;

  /** Remaining LBSC that will be collectively rewarded to liquidity miners. */
  remainingLiquidityMiningLQTYReward: Decimal;

  /** Amount of Uniswap BNB/FUSD LP tokens the user has staked in liquidity mining. */
  liquidityMiningStake: Decimal;

  /** Total amount of Uniswap BNB/FUSD LP tokens currently staked in liquidity mining. */
  totalStakedUniTokens: Decimal;

  /** Amount of LBSC the user has earned through mining liquidity. */
  ...
  /** Total amount of FUSD currently deposited in the Stability Pool. */
  ...
  /** Remaining LBSC that will be collectively rewarded to stability depositors. */
  ...
  /** Total amount of LBSC currently staked. */
...
export interface LiquityStoreDerivedState {
   ...
   *
   * @remarks
   * Note that the actual rate paid by a redemption transaction will depend on the amount of FUSD
   * being redeemed.
   *
