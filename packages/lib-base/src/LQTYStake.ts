...
/**
 * Represents the change between two states of an LBSC Stake.
 *
 * @public
 */
...
/** 
 * Represents a user's LBSC stake and accrued gains.
 * 
 * @remarks
...
export class LQTYStake {
  /** The amount of LBSC that's staked. */
   ...
   *
   * @returns The new staked LBSC amount.
   */
